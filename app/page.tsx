...
export default function Home() {
    return (
        <Wrapper>
            <Title>👋 Добро пожаловать в Digital Night Team</Title>
            <Subtitle>
                Мы создаём стильные, современные и тёмные веб-приложения.<br />
                ...
                <Dialog.Portal>
                    ...
                    <StyledDialogContent>
                        ...
                        <Dialog.Description style={{ color: '#a1a1aa', marginBottom: '1.5rem', textAlign: 'center' }}>
                            Digital Night Team — это команда энтузиастов, которые любят тёмные темы, современные технологии и креативные решения. Мы ценим инновации, качество и дружескую атмосферу!
                        </Dialog.Description>
